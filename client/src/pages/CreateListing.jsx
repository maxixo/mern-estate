  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form className="flex flex-col sm:flex-row gap-4">
        <div className='sm:flex-row flex-1 gap-4'>
        <div className="flex flex-col gap-4 flex-1 ">
            ...
            id="description" maxLength="62" required />
            <input  type="text" placeholder="address" className="border p-3 rounded-lg"
            id="address" required />
        </div>
        <div className="flex gap-6 flex-wrap mt-4 flex-1">
        ...
        <div className="flex gap-2">
           ...
           <div className='flex flex-wrap gap-6'> 
            ...
            <input type="number" id="bedroom" min="1" max="10"
            ...
            <p>Beds</p>
             ...
             className='p-3 border border-gray-300 rounded-lg'/>
             <div className='flex fkex-col items-center'>
              <p>Regular price</p>
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex gap-4'>
           ...
           className='p-3 border border-gray-30 rounded w-full' multiple/>
           ...
           rounded uppercase hover:shadow-lg disabled:opacity-80 ' >Upload</button>
                   ...
                   <button className='p-3 bg-slate-700 text-white rounded-lg uppercase:opecity-95 '>Create Listing</button>
